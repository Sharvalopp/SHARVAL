...
module.exports = {
    ...
    run: async (client, interaction, lang) => {
        try {
            const supportServerLink = "https://discord.gg/s8HhBvav";
            const githubLink = "https://github.com/Sharvalopp";
            const replitLink = "https://replit.com/@Sharval";
            const youtubeLink = "https://www.youtube.com/SHARVAL";
